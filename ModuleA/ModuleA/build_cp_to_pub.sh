...
xcodePath=/usr/bin
sdkDevice="iphoneos10.0"
sdkSimulator="iphonesimulator10.0"
...
project_name="ModuleA.xcodeproj"
runTarget='ModuleA'
iphone_com_path="${root_path}/../../Library/ModuleA"
...
cd $iphone_com_path/Release-iphoneos
lib_md5=`md5 lib${runTarget}.a`
md5_value=$(echo $lib_md5 | awk '{print $4}')

cd $root_path
python generateConfigInfo.py -f $iphone_com_path/${runTarget}_config.txt -m $md5_value
